...
<body text=#000000 bgColor="#ffffff" leftMargin=0 topMargin=4>
	...
	<div id="main">
		...
		<form name=alipayment action=jsp/alipay.trade.page.pay.jsp method=post
			target="_blank">
		...
		<form name=tradequery action=jsp/alipay.trade.query.jsp method=post
			target="_blank">
		...
		<form name=traderefundquery
			action=jsp/alipay.trade.fastpay.refund.query.jsp method=post
			target="_blank">
		...
		<form name=tradeclose action=jsp/alipay.trade.close.jsp method=post
			target="_blank">
